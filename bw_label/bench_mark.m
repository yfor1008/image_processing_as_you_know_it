...
if ~exist('time_elapased.mat', 'file')
    ...
    save('time_elapased.mat', 'run_times_matlab', 'run_times_seedfill', 'run_times_contourtrace', 'pixels')
else
...
semilogy(pixels, run_times_contourtrace*1000, 'LineWidth', 1.1)
legend('matlab', 'seedfill', 'contourtrace')
